...
ActiveRecord::Schema.define(version: 20180118100321) do
  ...
  create_table "explore_categories", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "exploreds", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "category_name"
    t.string "keywords"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
