...
class V1::Designers::ConversationsController < V1::Designers::BaseController
  ...
  def create
    conversation =  Conversation.find_by_receiver_id_and_receiver_type(params[:receiver_id], params[:receiver_type]) || current_designer.conversations.create(receiver_id: params[:receiver_id], receiver_type: params[:receiver_type])
    if conversation
