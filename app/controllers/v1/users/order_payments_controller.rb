...
class V1::Users::OrderPaymentsController < V1::Users::BaseController
  ...
  def notify_payment_success(op)
   begin
      body = "Your payment was successful for the offer by #{ op.order.designer.full_name } for #{ op.order.offer_quotation.offer.request.name }. Please provide measurements in Manage Orders."
