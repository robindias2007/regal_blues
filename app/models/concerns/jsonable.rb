  ...
  included do
	  ...
	  def as_order_json
	    self.orders.collect{|order| {
	      ...
	      request_name: order.offer_quotation.offer.request.name,
	      item_type: order.offer_quotation.offer.request.sub_category.name,
	      shipping_price: order.offer_quotation.shipping_price,
