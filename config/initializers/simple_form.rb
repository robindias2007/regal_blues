...
SimpleForm.setup do |config|
  ...
  config.wrapper_mappings = {
    text: :materialize_text_area, string: :materialize_string, email: :materialize_string,
    tel: :materialize_string, number: :materialize_string, integer: :materialize_string,
    decimal: :materialize_string, date: :materialize_date, check_boxes: :materialize_multiple,
    radio_buttons: :materialize_multiple, switch: :material_checkbox, file: :materialize_file_input
  }
