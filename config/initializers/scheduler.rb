...
# 				end
# 				body = "Hi #{f.user.full_name}! As per the designers, the budget is too low for the garment. Request you to modify the same by letting us know via chat. Please make sure to enter your maximum budget, if your budget is low for the outfit requested and no options are possible then you will not get any offers from designers. Also note that designers will send you fabric options and work based on your budget and what best can be done close to your budget. Thank You!"
